    ...
    <>
      ...
      <div className="w-100 grid grid-cols-2 gap-28 motion-safe:animate-move-bottom">
        <div className="w-50 max-h-[50svh] flex flex-col aspect-square justify-center items-center border-neutral-800 border-2 rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-neutral-500 hover:scale-105 transition duration-300 motion-reduce:transition-none">
          <Image src="/test.jpg" width={500} height={500} quality={50} alt="Picture of project1" className="object-cover max-w-50 rounded-l" />
        ...
        <div className="w-50 max-h-[50svh] flex flex-col aspect-square justify-center items-center border-neutral-800 border-2 rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-neutral-500 hover:scale-105 transition duration-300 motion-reduce:transition-none">
          <Image src="/test.jpg" width={500} height={500} quality={50} alt="Picture of project2" className="object-cover max-w-50 rounded-l" />
          <div className="h-full w-full flex flex-col bg-neutral-950/75 justify-center items-center backdrop-blur-md">
            <div className="w-[30ch] justify-start items-center flex flex-row mb-2 gap-4">
